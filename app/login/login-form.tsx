    ...
    return (
        ...
        >
            <CardHeader className="space-y-1 text-center" style={{ padding: '1.5rem', textAlign: 'center' }}>
                ...
                <CardTitle className="text-2xl font-bold tracking-tight" style={{ fontSize: '1.5rem', fontWeight: 'bold', letterSpacing: '-0.025em', color: '#fff', margin: 0 }}>Secure File Viewer</CardTitle>
            ...
            <CardFooter className="justify-center border-t border-border/50 pt-6 mt-2" style={{ justifyContent: 'center', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '1.5rem', marginTop: '0.5rem', paddingBottom: '1.5rem' }}>
                <p className="text-xs text-muted-foreground text-center" style={{ fontSize: '0.75rem', color: '#71717a', textAlign: 'center', margin: 0 }}>
                    Restricted access. Requires <code className="bg-muted px-1.5 py-0.5 rounded text-foreground font-mono font-medium" style={{ backgroundColor: 'rgba(255,255,255,0.1)', padding: '0.125rem 0.375rem', borderRadius: '0.25rem', color: '#fff', fontFamily: 'monospace', fontWeight: 500 }}>user</code> role.
                </p>
            </CardFooter>
        </Card>
    );
