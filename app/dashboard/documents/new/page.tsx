...
export default function UploadDocumentPage() {
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (!allowedMimeTypes.includes(selectedFile.type)) {
            setError('Only PDF and image files (JPG, JPEG, PNG, WEBP, BMP) are allowed');
            setFile(null);
            return;
        }
        ...
        if (!title) {
            const baseName = selectedFile.name.replace(/\.(pdf|jpe?g|png|webp|bmp)$/i, '');
            setTitle(baseName);
        }
    };
    ...
    return (
        <>
            ...
            {toast && (
                <div className={cn(
                    "fixed top-4 right-4 z-50 p-4 rounded-lg shadow-lg animate-in fade-in slide-in-from-top-2",
                    toast.type === 'error'
            ...
            <div className="max-w-3xl mx-auto space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Add a new file to your secure library</p>
                    </div>
                </div>
                                    ...
                                    {file ? (
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <p className="text-xs text-muted-foreground">PDF, JPG, PNG, WEBP, BMP (up to 10MB)</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
